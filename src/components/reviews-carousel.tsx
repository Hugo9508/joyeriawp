...
const REVIEWS: Review[] = [
  {
    ...
    stars: 5,
    time: "6 días atrás",
    text: "¡Excelente, nota 10! La atención fue fantástica y los consejos fueron geniales. Recomiendo mucho el lugar.",
    initial: "C",
    color: "#f472b6",
    photo: "https://i.imgur.com/bEdWImH.png",
  },
  {
    name: "Nay Buono",
    badge: "Local Guide",
  ...
  },
  {
    ...
    stars: 5,
    time: "6 meses atrás",
    text: "Excelente atención y los mejores precios, 5⭐️",
    initial: "R",
    color: "#c084fc",
    photo: null,
  },
  ...
  },
  {
    ...
    stars: 5,
    time: "7 meses atrás",
    text: "La atención fue muy amable, las alianzas son hermosas y la tiara es encantadora 🙌",
    initial: "L",
    color: "#fbbf24",
    photo: null,
  },
